...
### Linux AMD64
```bash
wget https://github.com/deviantony/pctl/releases/latest/download/pctl_1.1.2_linux_amd64.tar.gz
tar -xzf pctl_1.1.2_linux_amd64.tar.gz
chmod +x pctl
...
### Linux ARM64
```bash
wget https://github.com/deviantony/pctl/releases/latest/download/pctl_1.1.2_linux_arm64.tar.gz
tar -xzf pctl_1.1.2_linux_arm64.tar.gz
chmod +x pctl
sudo mv pctl /usr/local/bin/
```
...
### macOS AMD64
```bash
wget https://github.com/deviantony/pctl/releases/latest/download/pctl_1.1.2_darwin_amd64.tar.gz
tar -xzf pctl_1.1.2_darwin_amd64.tar.gz
chmod +x pctl
sudo mv pctl /usr/local/bin/
```
...
```bash
wget https://github.com/deviantony/pctl/releases/latest/download/pctl_1.1.2_darwin_arm64.tar.gz
tar -xzf pctl_1.1.2_darwin_arm64.tar.gz
chmod +x pctl
sudo mv pctl /usr/local/bin/
```
